...
function getData() {
  ...
  fetch(
    `https://api.openweathermap.org/data/2.5/weather?q=${cityName}&appid=09b242f2ab486e4fee26696f90388209`
  )
  ...
  console.log(currentDate)
      ...
      createMinMaxTemp.innerText =
        (result.main.temp_max - 273.15).toFixed(2) + '°c' + ' / ' + (result.main.temp_min-273.15).toFixed(2) + '°c';
